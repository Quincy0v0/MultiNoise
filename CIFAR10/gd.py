...
parser.add_argument('--datadir', type=str, default=r'C:\Users\chenp2\datasets\CIFAR10\numpy')
parser.add_argument('--logdir', type=str, default=r'logs\GD')
...
for i in range(start_iter, args.iters):
    ...
    model.train()
    optimizer.zero_grad()
    train_list = dataset.getTrainList(args.batchsize, args.aug, True)
